...
public class MemberSystem {
	public static void main(String[] args) {
		...
		Member[] memberList = new Member[100]; 	System.out.println("memberList"+memberList);
		...
		while(true) {
			...
			if(ch == 1 ){
				...
				System.out.print("아이디  :"); 	String inputId =in.next(); //기본타입 : 스택
				System.out.print("비밀번호  :");  	String inputpPwd =in.next(); //기본타입 : 스택
				System.out.print("이름  :");  	String inputName =in.next(); //기본타입 : 스택
				System.out.print("전화번호  :");  String inputPhone =in.next(); //기본타입 : 스택
