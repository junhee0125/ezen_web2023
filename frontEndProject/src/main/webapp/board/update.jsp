...
<body>
	...
	<div class="container">	
		...
		<div class="row justify-content-md-center my-3">
			<div class="col-2"><input onclick="onUpdate()" class="form-control btn btn-dark" type="button" value="수정하기"></div>  
			<div class="col-2"><input class="form-control btn btn-secondary" type="button" value="다시쓰기"></div>
			<div class="col-2"><a href="list.jsp"><input class="form-control btn btn-secondary" type="button" value="목록보기"></a></div>
		</div>
