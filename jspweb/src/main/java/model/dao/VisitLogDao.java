...
public class VisitLogDao extends Dao{
	 ...
	 */
	public boolean vRead(VisitLogDto VisitLogDto) {
	...
	/**
	 * 3.수정 [인수 : 수정할 방문록번호O / 리턴 : 성공/싶패(boolean) = true/false]
	 */
	public boolean vUpdate() {
		 return false;
	...
	/**
	 * 4. [인수 : 삭제할 번호(int) / 리턴 : 성공/싶패(boolean) = true/false] 
	 */
	public boolean vDelete() {
		 return false;
